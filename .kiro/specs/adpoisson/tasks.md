...
- [ ] 4. 解析解とソース項の実装 (`src/problems.jl`)
  ...
  - _Requirements: 解析解_
- [ ] 5a. Laplacian 演算子の実装 (`src/core.jl`) (P)
  - `laplacian!(Lu, u, config)`
  - 7点差分の実装
  - _Requirements: Taylor級数漸化式_
- [ ] 5b. Taylor係数計算ルーチンの実装 (`src/core.jl`) (P)
...
- [ ] 9. 可視化機能の実装 (`src/visualization.jl`)
